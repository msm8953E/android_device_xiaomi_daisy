...
# Device common 
 git clone https://github.com/xiaomi-msm8953-devs/android_device_xiaomi_msm8953 -b lineage-22.2 device/xiaomi/msm8953-common 

# Vendor Blobs 
git clone https://github.com/xiaomi-msm8953-devs/proprietary_vendor_xiaomi_daisy -b lineage-22.2 vendor/xiaomi/daisy
git clone https://github.com/xiaomi-msm8953-devs/proprietary_vendor_xiaomi_msm8953 -b lineage-22.2 vendor/xiaomi/msm8953-common
